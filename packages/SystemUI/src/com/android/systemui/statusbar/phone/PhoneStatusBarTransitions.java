...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public void init() {
        ...
        mdndLogoRight = mView.findViewById(R.id.dnd_logo);
        mdndLogoLeft = mView.findViewById(R.id.left_dnd_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mdndLogoRight, newAlphaBC),
                    animateTransitionTo(mdndLogoLeft, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mdndLogoRight.setAlpha(newAlphaBC);
            mdndLogoLeft.setAlpha(newAlphaBC);
        }
    }
}
